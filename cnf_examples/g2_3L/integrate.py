...
if __name__ == "__main__":
    ...
    vertex3L.use_Qmc(verbosity=0, minn=1, maxeval=int(1e15), fitfunction=fit)

    str_integral_without_prefactor, str_prefactor, str_integral_with_prefactor = vertex3L(real_parameters=[1.0], epsrel=0, epsabs=precision, verbose=True)
